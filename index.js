...
const FeedbackyContext = reactExports.createContext(initialContextValue);
const useFeedbackyContext = () => reactExports.useContext(FeedbackyContext);
const MODAL_SUCCESS_DEFAULT_TEXT = "Your feedback saved successfully!";
const SEND_FEEDBACKY_BUTTON_DEFAULT_TEXT = "Send Feedback";
const FEEDBACKY_BUTTON_DEFAULT_SIZE = 40;
const FEEDBACKY_MODAL_NAME_INPUT_DEFAULT_PLACEHOLDER = "Enter your name";
const FEEDBACKY_MODAL_SURNAME_INPUT_DEFAULT_PLACEHOLDER = "Enter your surname";
const FEEDBACKY_MODAL_SUCCESS_ICON_DEFAULT_SIZE = 60;
const FEEDBACKY_MODAL_SUCCESS_ICON_DEFAULT_COLOR = "green";
const FEEDBACKY_MODAL_FEEDBACK_INPUT_DEFAULT_PLACEHOLDER = "Give your feedback";
const FEEDBACKY_MODAL_TITLE_DEFAULT_TEXT = "We would be happy to get your feedback!";
const GOOGLE_SHEET_SERVICE_BASE_URL = "https://sheet.best/api/sheets/";
const FeedbackyButton = ({ onClick }) => {
  const {
...
const FeedbackyModalSuccess = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center flex-col gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      IoCheckmarkCircleOutline,
      {
        size: modalSuccessIconSize || FEEDBACKY_MODAL_SUCCESS_ICON_DEFAULT_SIZE,
        color: modalSuccessIconColor || FEEDBACKY_MODAL_SUCCESS_ICON_DEFAULT_COLOR
      }
    ),
...
const FeedbackyButtonLoading = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AiOutlineLoading3Quarters, { className: "animate-spin" });
};
...
axios.default = axios;
const axios$1 = axios;
const postFeedback = ({ googleSheetId, data }) => {
  return axios$1.post(`${GOOGLE_SHEET_SERVICE_BASE_URL}${googleSheetId}`, data);
};
var HTTP_STATUS = /* @__PURE__ */ ((HTTP_STATUS2) => {
  HTTP_STATUS2[HTTP_STATUS2["OK"] = 200] = "OK";
  return HTTP_STATUS2;
})(HTTP_STATUS || {});
const FeedbackyModalButton = ({
  loading
}) => {
  const {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        ...
        loading && /* @__PURE__ */ jsxRuntimeExports.jsx(FeedbackyButtonLoading, {})
      ]
    }
  );
};
const FeedbackyModalInput = ({
  placeholder,
  value,
  onChange
}) => {
...
const FeedbackyModalInputs = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FeedbackyModalInput,
      {
        placeholder: nameInputPlaceholder || FEEDBACKY_MODAL_NAME_INPUT_DEFAULT_PLACEHOLDER,
        value: name,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FeedbackyModalInput,
      {
        placeholder: surnameInputPlaceholder || FEEDBACKY_MODAL_SURNAME_INPUT_DEFAULT_PLACEHOLDER,
        value: surname,
...
const FeedbackyModalTextArea = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "textarea",
    {
      ...
      placeholder: feedbackInputPlaceholder || FEEDBACKY_MODAL_FEEDBACK_INPUT_DEFAULT_PLACEHOLDER,
      value: comment,
      onChange: handleCommentChange
    }
  ) });
};
const FeedbackyModalTitle = () => {
  const {
    feedbackyProps: { modalTitle }
  } = useFeedbackyContext();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-semibold text-center text-xl text-gray-700 mb-7", children: modalTitle || FEEDBACKY_MODAL_TITLE_DEFAULT_TEXT }) });
};
const FeedbackyModalForm = () => {
  const { feedbackPostRequestLoading } = useFeedbackyContext();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(FeedbackyModalTitle, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FeedbackyModalInputs, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FeedbackyModalTextArea, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FeedbackyModalButton, { loading: feedbackPostRequestLoading })
  ] });
};
const FeedbackyModal = ({ show, onClose }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "form",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-blue-200 p-10 rounded w-96 h-144", children: feedbackSavedSuccessfully ? /* @__PURE__ */ jsxRuntimeExports.jsx(FeedbackyModalSuccess, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(FeedbackyModalForm, {}) })
    }
  );
};
const index = "";
const Feedbacky = (feedbackyProps) => {
  const [showModal, setShowModal] = reactExports.useState(false);
  const [name, setName] = reactExports.useState("");
  const [surname, setSurname] = reactExports.useState("");
  const [comment, setComment] = reactExports.useState("");
  const [feedbackSavedSuccessfully, setFeedbackSavedSuccessfully] = reactExports.useState(false);
  const [feedbackPostRequestLoading, setFeedbackPostRequestLoading] = reactExports.useState(false);
  const contextValue = {
    form: {
      name,
      setName,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(FeedbackyContext.Provider, { value: contextValue, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(FeedbackyButton, { onClick: handleFeedbackyButtonClick }),
    showModal && /* @__PURE__ */ jsxRuntimeExports.jsx(FeedbackyModal, { show: showModal, onClose: handleOnClose })
  ] });
};
const feedbacky = {
  run: (feedbackyProps) => {
    client.createRoot(document.getElementById("feedbacky-container")).render(
      /* @__PURE__ */ jsxRuntimeExports.jsx(Feedbacky, { ...feedbackyProps })
    );
  }
};
